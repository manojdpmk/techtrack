		...
		<div class="row" style="margin-top: 3%;">
			<div class="col-md-12">
				<ul class="nav nav-pills">
					<li class="active"><a href="#pending" data-toggle="tab"><i class="fa fa-list"></i>&nbsp;&nbsp;Pending Issues</a></li>
					<li><a href="#reserved" data-toggle="tab"><i class="fa fa-question"></i>&nbsp;&nbsp;Accepted Issues</a></li>
				</ul>
			</div>
		</div>
