	...
	<ul class="nav menu">
		...
		<li class="parent ">
			<a href="#sub-item-1" data-toggle="collapse">
					<span data-toggle="collapse" href="#sub-item-1"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-chevron-down"></use></svg></span>Records 
				</a>
		...
		<div class="container-fluid">
			<form class="frm_addroom">
				...
				<div class="form-group">
					...
					<input type="varchar" name="room_name" min="0" class="form-control" autofocus autocomplete="off" required>
				</div>
				<div class="form-group">
					<div class="row">
						<div class="col-md-6">
